					3ABSTRACT*
.sp 3
	This report surveys eight automatic test equipment languages, ATLAS,
EQUATE ATLAS, VITAL, CTL, GOAL, OPAL, PROTEST and GAELIC.  Each language is
reviewed and critiqued using criteria developed in the report.  There is also
a short discussion of compiler generators for automatic test equipment languages.
.bp
				3ACKNOWLEDGEMENTS*
.sp 3
	I wish to thank Gary Goddard, David Loveman and Don Garmer for help in
...
controlling the test equipment through stepping switches, cam and motor setups and
...
more speed, greater capability
to perform a variety of operations, larger
storage capacities and more adaptability to changing requirements than previous test
...
For example, on the U.S. Navy's SIMETS test station [Goddard 77] the devices being
...
equipment such as an electronic switching system.  Today, a myriad of different
...
[Liskov 74].  In this manner, a good abstraction allows one to
...
is usually done by a switching matrix.
	A typical direct control ATE language is a conventional programming language
...
specific pieces of test equipment and their symbolic names; he thinks in terms of
...
discussion of compiler generators for ATE languages.  Finally, Section 3 discusses
