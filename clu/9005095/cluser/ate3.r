...
level of abstraction of the languages in this report is summarized below in Figure 23.
...
They are only intended for writing tests specifications.  From a programmer's point of
...
programmer more powerful constructs than found in the direct control languages.
...
.ls 1
	ARINC 416
	IEEE/ARINC Standard - ATLAS Test Language
	IEEE Std 416-1976

	Brachman, R. J.
	Functional Description of the Operational Performance Analysis Lnaguage (OPAL)
	ASSC 74 Record, IEEE Publication 74CH0891-2AES

	Dickison, L. R.
	Ground Operations Aerospace Language (GOAL) Textbook
	NASA-TM-X-69542,   April 1973

	Ellis, M.
	VITAL - A General Purpose Multiple Dialect Automatic Test Language
	ASSC 1970 Record, IEEE Publication 70C 52-AES, October 1970

	Ellis, M.
	The Dialect Concept in ATE Language Design
	WESCON 1971, August 24-27, paper 14/2

	Ellison, T. A.
	A Progress Report on the ATLAS Language
	1973 IEEE International Convention and Exposition, VOL. VII-VIII, March 1973

	Fuller, E. J. and Proctor, J. A.
	The Evolution and Development of a Digital Test Cpability for VAST
	ASSC 1970 Record, IEEE Publication 70C 52-AES, October 1970
	
	Garcia-Aguilar, G.
	Languages for Programming Automatic Test Equipment Including an Introduction
	to Analog and Digital Computers
	New York University, Jan. 1969

	Gill, M. H.
	PROTEST: A Language for Testing
	Computers and Automation, May 1973

	Goddard, G., Garmer, D. and Principato, R.
	A Functional Description of the SIMETS Software Development Station
	C-4914, Charles Stark Draper Laboratory, August 1977
	...
	Kelley, J. and Toscano, P. M.
	EQUATE - New Concepts in Automatic Testing
	RCA Burlington Mass Aerospace Systems 1973

	Liguori, F.
	The Test Language Dilemma
	Proc. ACM National Convention. Aug. 1971

	Liskov, B. H. and Zilles, S.
	Specification Techniques for Data Abstractions
	IEEE Transactions in Software Engineering, SE-1, Vol. 1, 1975

	Loveman, D.
	CTL - A Programming Lnaguage for Automatic Testing
	ASSC 73 Record, IEEE Publication 73 CHO 804-5 AES

	Loveman, D.
	Structured Test Programming and the COMPASS Test Language
	ASSC 74 Record, IEEE Publication 774CH0891-2AES

	Loveman, D.
	Language Design for Automatic Test Equipment
	1977 IEEE International Automatic Testing Conference, Nov. 1977

	Lustig, J.
	Trends in the Development of Automatic Test Equipment
	New York University, June 1973

	Mattison, R. L. and Mitchell, R. T.
	UTEC - A Universal Test Equipment Compiler
	ASSC 68 Record, IEEE

	Muntz, C., Loveman, D. and Myszewski, M.
	MAIDS Technical Report
	Massachusetts Computer Associates, Inc., Wakefield, Ma., Dec. 1972

	OPAL 77
	Operational Performance Analysis Language (OPAL)
	U. S. Army, Proposed MIL-STD-1462, Change 3, Jan. 1977

	Stolov, S. E.
	GAELIC - Grumman Aerospace Engineering Language for Instructional Checkout
	ASSC 72 Record, IEEE

	Turkington, R. E.
	The EQUATE ATLAS Implementation and Future ATLAS Expectations
	ASSC 75 Record, IEEE Publication 75CH1007-4AES

	VITAL 75
	User's Gide to the VITAL Language
	NAVAIR DOC NO. 16-30USM247-400-5
	RLG Associates, Inc., Reston, Virginia, May 1975

	Warshall, S., Loveman, D. and Muntz, C.
	CTL - Compass Test Language
	Massachusetts Computer Associates, Inc., Wakefield, Ma., June 1974

	Went, B. H.
	The Compiler for the Programming Language for Automatic Checkout Equipment
	(PLACE): Part 1 PLACE
	Battelle Memorial Institute, Columbus, Ohio, May 1968

	Went, B. H.
	ATLAS/PLACE Compatibility Study
	Battelle Memorial Institute, Columbus, Ohio, August 1971